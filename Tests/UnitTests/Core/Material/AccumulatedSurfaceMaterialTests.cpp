...
BOOST_AUTO_TEST_CASE(AccumulatedSurfaceMaterial_construction_test) {
  ...
  DirectedProtoAxis axis00(AxisDirection::AxisX, AxisBoundaryType::Open, -5., 5., 10);
  ...
  DirectedProtoAxis axis10(AxisDirection::AxisX, AxisBoundaryType::Open, -5., 5., 10);
  DirectedProtoAxis axis11(AxisDirection::AxisY, AxisBoundaryType::Open, -10., 10., 20);
...
BOOST_AUTO_TEST_CASE(AccumulatedSurfaceMaterial_fill_convert_1D) {
  ...
  DirectedProtoAxis axis0{AxisDirection::AxisX, AxisBoundaryType::Open, -1., 1., 2};
  DirectedProtoAxis axis1{AxisDirection::AxisY, AxisBoundaryType::Open, -1., 1., 2};
